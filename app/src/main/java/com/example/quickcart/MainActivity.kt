...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadDummyData() {
        allProducts.apply {
            ...
            add(Product(3, "Organic Carrots", 0.99, R.drawable.img_carrots, "Vegetables"))
            add(Product(4, "Broccoli Crown", 1.89, R.drawable.img_broccoli, "Vegetables"))
            add(Product(5, "Whole Milk 1L", 2.49, R.drawable.img_milk, "Dairy"))
            add(Product(6, "Cheddar Cheese", 4.99, R.drawable.img_cheese, "Dairy"))
            add(Product(7, "Potato Chips", 3.49, R.drawable.img_snacks, "Snacks"))
            add(Product(8, "Mixed Nuts", 6.99, R.drawable.img_snacks, "Snacks"))
            add(Product(9, "Orange Juice", 3.99, R.drawable.img_juice, "Drinks"))
            add(Product(10, "Sparkling Water", 1.29, R.drawable.img_water, "Drinks"))
        }
